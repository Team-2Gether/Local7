...
COMMENT ON COLUMN TB_REVIEW.USER_ID IS '리뷰 작성자 ID (TB_USER 테이블의 USER_ID 참조)'; -- Comment updated
COMMENT ON COLUMN TB_REVIEW.RESTAURANT_ID IS '리뷰 대상 맛집 ID (TB_RESTAURANT 테이블의 RESTAURANT_ID 참조)'; -- Comment updated

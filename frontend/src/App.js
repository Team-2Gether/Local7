      ...
      <div className="main-content-area">
        ...
        <div className="content-with-sidebar">
          <Routes>
            ...
            <Route
              path="/userpage"
              element={<Navigate to="/mypage/edit" replace />}
            />
  ...
  return (
    <div className="user-info-section">
      <div className="profile-image-container">
        <img
          src={
            userData.userProfileImageUrl || "https://via.placeholder.com/150"
          }
          alt="프로필 이미지"
      ...
      <div className="user-details">
        <p>
          <strong>아이디:</strong> {userData.userLoginId}
        </p>
        <p>
          <strong>닉네임:</strong> {userData.userNickname}
        </p>
        <p>
          <strong>이메일:</strong> {userData.userEmail}
        </p>
        <p>
          <strong>이름:</strong> {userData.userName}
        </p>
        <p>
          <strong>소개:</strong> {userData.userBio || "작성된 소개가 없습니다."}
        </p>
        <p>
          <strong>가입일:</strong>{" "}
